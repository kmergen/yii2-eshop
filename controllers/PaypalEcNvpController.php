...
/**
 * PaymentEcController implements the actions for Express Checkout via Paypal NVP API.
 */
class PaypalEcNvpController extends Controller implements PaymentEventInterface
{
    ...
    public function actionSuccess()
    {
        ...
        $pp = Yii::createObject(Yii::$app->getModule('eshop')->paygates['paypal_ec_nvp']);
